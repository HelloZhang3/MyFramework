...
import com.zyd.myframework.util.ArrayUtil;
    ...
    public void alert(final Context context, Object object) {
        ...
        if (null == dialog) {
            dialog = new AlertDialog.Builder(context)
                    .setNegativeButton(context.getResources().getString(R.string.log_copy), listener)
                    .setPositiveButton(context.getResources().getString(R.string.log_cancel), listener)
                    .create();
